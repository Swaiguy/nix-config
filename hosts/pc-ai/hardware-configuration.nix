...
#
{
  ...
  boot.initrd = {
    ...
    luks.devices."crypted-nixos" = {
      ...
      device = "/dev/disk/by-uuid/6a7b12f0-30dc-41b1-89dc-97caf9f10d79";
  ...
  fileSystems."/btr_pool" = {
    device = "/dev/disk/by-uuid/5a06ea2e-f65b-4a50-a3cb-8206d20dc349";
    fsType = "btrfs";
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/6791-7DF8";
    fsType = "vfat";
  };
